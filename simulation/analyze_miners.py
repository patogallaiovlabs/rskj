...
def analyze_coinbases(filename):
    ...
    known_miners = {
        ...
        "0xce7864a8b5bf360b01099502a163810cec845d4a": "Foundry USA",
        "0x93293a100338f54242f05652e137a52e0acdccf0": "ViaBTC",
        "0x93293a100338f54242f05652e137a52e0acdccf0": "ViaBTC",
    ...
    try:
        ...
        known_miner_stats = [(addr, coinbase_counts.get(addr, 0), known_miners[addr]) 
                           for addr in known_miners]
