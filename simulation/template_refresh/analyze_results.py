...
def plot_histograms(pool_intervals, bin_size):
    ...
    pool_order = ['Luxor', 'AntPool', 'ViaBTC', 'F2Pool', 'SpiderPool', 'Parasite']
    ...
    # Determine the unified bin edges for all histograms
    max_interval = max(max(intervals) for intervals in ordered_pools.values())
