...
miner {
    server.enabled = true
    server.skipPowValidation = true  # optional, useful for regtest/stress runs
...
- **`server.skipPowValidation`**: Optional regtest/testing flag to bypass PoW checks on submitted blocks
