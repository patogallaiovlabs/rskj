...
public class Unitrie extends javax.swing.JFrame {
    ...
    private void recoverButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recoverButtonActionPerformed
        ...
        new Thread(() -> {
            ...
            Optional<TrieDTO> recovered = TrieDTOInOrderRecoverer.recoverTrie(nodeArray, t -> {
            });
    ...
    private TrieDTO find(DefaultMutableTreeNode uiNode, TrieKeySlice key) {
        ...
        final TrieKeySlice sharedPath = TrieKeySlice.fromKey(node.getPath());
    ...
    private void runNode(Runtime runtime, PreflightChecksUtils preflightChecks, RskContext ctx) throws Exception {
